...
public class VersusScreenAnalyserImpl implements VersusScreenAnalyser {
     ...
     *            image
     * @param x
     *            x-coordinate, based on a 720p image
     * @param y
     *            y-coordinate, based on a 720p image
     * @return rgb
     */
    ...
    private BufferedImage getSubImage(BufferedImage image, int x, int y, int w, int h) {
        return image.getSubimage(x * image.getWidth() / SCREEN_WIDTH, y * image.getHeight() / SCREEN_HEIGHT,
                w * image.getWidth() / SCREEN_WIDTH, h * image.getHeight() / SCREEN_HEIGHT);
    }
