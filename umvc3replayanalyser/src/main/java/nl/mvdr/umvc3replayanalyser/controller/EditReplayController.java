...
class EditReplayController {
    ...
    EditReplayController(final Game defaultContents, @NonNull final ReplayDetailsEditedHandler okHandler,
        ...
        this.defaultContents = defaultContents;
        this.okHandler = okHandler;
        this.playerOneTextField = playerOneTextField;
        this.playerTwoTextField = playerTwoTextField;
        this.playerOneCharacterOneComboBox = playerOneCharacterOneComboBox;
        this.playerOneCharacterTwoComboBox = playerOneCharacterTwoComboBox;
        this.playerOneCharacterThreeComboBox = playerOneCharacterThreeComboBox;
        this.playerTwoCharacterOneComboBox = playerTwoCharacterOneComboBox;
        this.playerTwoCharacterTwoComboBox = playerTwoCharacterTwoComboBox;
        this.playerTwoCharacterThreeComboBox = playerTwoCharacterThreeComboBox;
        this.playerOneAssistOneComboBox = playerOneAssistOneComboBox;
        this.playerOneAssistTwoComboBox = playerOneAssistTwoComboBox;
        this.playerOneAssistThreeComboBox = playerOneAssistThreeComboBox;
        this.playerTwoAssistOneComboBox = playerTwoAssistOneComboBox;
        this.playerTwoAssistTwoComboBox = playerTwoAssistTwoComboBox;
        this.playerTwoAssistThreeComboBox = playerTwoAssistThreeComboBox;
        this.okButton = okButton;
        this.assistComboBoxes = assistComboBoxes;
    }
}